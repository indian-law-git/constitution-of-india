...
> **Documented gap.** List III (Concurrent List) on CLPR does not carry a Version 2 (1950) section — only the current consolidated text is shown. Because the 42nd Amendment, 1976, moved items between State List and Concurrent List, the current text is not a faithful 1950 baseline and this segment is a documented gap pending manuscript transcription.
